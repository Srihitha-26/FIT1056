    ...
    def main_menu(self) -> list[str]:
        ...
        if self.user == None:
            ...
            if isinstance(self.user, Investor):
                ...
                menuOptions.append("View Feedback")
            elif isinstance(self.user, Educator):
                menuOptions.append("Add Module")
                menuOptions.append("Remove Module")
                ...
                menuOptions.append("Attempt Module")
                menuOptions.append("Change Associated School")
                menuOptions.append("Set Educator")

            menuOptions.append("Provide Feedback")
